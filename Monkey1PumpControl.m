function varargout = Monkey1PumpControl(varargin)
% MONKEY1PUMPCONTROL MATLAB code for Monkey1PumpControl.fig
%      MONKEY1PUMPCONTROL, by itself, creates a new MONKEY1PUMPCONTROL or raises the
%       existing singleton*.
%
%      H = MONKEY1PUMPCONTROL returns the handle to a new MONKEY1PUMPCONTROL or the
%       handle to the existing singleton*.
%
%      MONKEY1PUMPCONTROL('CALLBACK',hObject,eventData,handles,...) calls the
%       local function named CALLBACK in MONKEY1PUMPCONTROL.M with the given
%       input arguments.
%
%      MONKEY1PUMPCONTROL('Property','Value',...) creates a new MONKEY1PUMPCONTROL or 
%       raises the existing singleton*.  Starting from the left, property 
%       value pairs are applied to the GUI before Monkey1PumpControl_OpeningFcn 
%       gets called.  An unrecognized property name or invalid value makes 
%       property application stop.  All inputs are passed to 
%       Monkey1PumpControl_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 31-Jul-2017 20:09:32

%%%%%%%% Begin initialization code - DO NOT EDIT %%%%%%%%%%%%%%%%%%%%%%%%%
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Monkey1PumpControl_OpeningFcn, ...
                   'gui_OutputFcn',  @Monkey1PumpControl_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Monkey1PumpControl is made visible. ------------
function Monkey1PumpControl_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Monkey1PumpControl (see VARARGIN)

% Choose default command line output for Monkey1PumpControl
handles.output = hObject;

%%%%%%%%%%%%%%%%%%%% ADDITIONAL INITIALIZATION CODE %%%%%%%%%%%%%%%%%%%%%%
% INITIALIZE THE PUMP
[handles.c1,handles.s] = initializePump;
...
function varargout = Monkey1PumpControl_OutputFcn(~, ~, handles) 
