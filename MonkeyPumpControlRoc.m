function varargout = MonkeyPumpControlRoc(varargin)
...
c2.drug.name = 'Rocuronium';
c2.drug.concentration = 1;
c2.drug.units = 'mg/mL';
c2.drug.doseUnits = 'mcg/kg/min';
c2.drug.instructions = '6mL drug (10mg/mL) + 54mL Ringer';
c2.drug.doseFactor = c2.subject.weight/c2.drug.concentration*60/1000;
c2.drug.doseMax = 30;
c2.drug.doseStep = 1;
c2.drug.doseInitial = 16;
...
%disp(userRate)
if ~(abs(userRate-pumpRate) < .05 && strcmp(str(10:11),'MH'))               % IF RATES DISAGREE
